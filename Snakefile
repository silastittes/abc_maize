...
for i in range(n_draws):
    param_str = f"abc_out/seed__{seeds[i]}_Na__{Na[i]}_N0__{N0[i]}_Nb__{Nb[i]}_Bt__{B_t[i]}_sfs1shape__{sfs1_shape[i]}_sfs1mean__{sfs1_mean[i]}_sfs2shape__{sfs2_shape[i]}_sfs2mean__{sfs2_mean[i]}_pneutral__{p_neutral[i]}_psfs1__{p_sfs1[i]}_sumstats.txt"
